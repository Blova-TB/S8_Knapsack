...
solver = tbns.tabou_numpy_solver(sad,10000,2000,2.4,0.1,seed)
# solver2 = tbcs.tabou_opencl_solver(sad2,1000,900,2.074,0.5,seed)
#solver3 = tb2s.tabou2_solver(sad2,1000,900,2.074,0.5,seed)
# print("numpy")
